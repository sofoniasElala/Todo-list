...
var ___CSS_LOADER_URL_IMPORT_0___ = new URL(/* asset import */ __webpack_require__(/*! ./Teko/Teko-VariableFont_wght.ttf */ "./src/Teko/Teko-VariableFont_wght.ttf"), __webpack_require__.b);
var ___CSS_LOADER_URL_IMPORT_1___ = new URL(/* asset import */ __webpack_require__(/*! ./plus-solid.svg */ "./src/plus-solid.svg"), __webpack_require__.b);
...
.create button, .side-bar button, .dialog-add, .dialog-cancel, .project-container button, .task-container button{
    font-size: 1rem;
    color: #FFFFFF;
    border-style: none;
...
.side-bar button:hover, .side-bar button:focus {
...
.project-container p, .task-container p {
    margin: 10px;
}
...
.create, .add-button {
    box-shadow: 0px 5px 8px 3px #8e8279;
}
...
.checkboxNname img, .project-icon-task{
    position: absolute;
    right: 20px;
}
...
.checkboxNname p, .checkboxNname img {
    font-size: 30px;
}
...
/*border style
body, header, .side-bar, .project-container, .create {
    border-style: solid;
} */`, "",{"version":3,"sources":["webpack://./src/style.css"],"names":[],"mappings":"AAAA;IACI,iBAAiB;IACjB,4CAA2C;AAC/C;AACA;IACI,kBAAkB;IAClB,aAAa;IACb,gCAAgC,EAAE,wCAAwC;IAC1E,4BAA4B;IAC5B,SAAS;IACT,eAAe;IACf,iBAAiB;IACjB,aAAa;IACb,kBAAkB,EAAE,2CAA2C;AACnE;;AAEA;IACI,kBAAkB;IAClB,eAAe;IACf,yBAAyB;IACzB,kBAAkB;AACtB;;AAEA;IACI,yBAAyB;IACzB,kBAAkB;IAClB,eAAe;IACf,aAAa;IACb,sBAAsB;IACtB,QAAQ;IACR,iBAAiB;AACrB;;AAEA;IACI,iBAAiB;;AAErB;;AAEA;IACI,eAAe;IACf,cAAc;IACd,kBAAkB;IAClB,yBAAyB;IACzB,oBAAoB;IACpB,eAAe;IACf,kBAAkB;IAClB,eAAe;AACnB;;AAEA;IACI,YAAY;AAChB;;AAEA;IACI,kBAAkB;IAClB,kBAAkB;IAClB,eAAe;IACf,yBAAyB;IACzB,2BAA2B;IAC3B,aAAa;IACb,sBAAsB;IACtB,SAAS;AACb;;AAEA;IACI,iBAAiB;AACrB;;AAEA;IACI,YAAY;AAChB;;AAEA;IACI,6DAA2C;IAC3C,qBAAqB;IACrB,kBAAkB;IAClB,YAAY;IACZ,WAAW;IACX,kBAAkB;IAClB,2BAA2B;IAC3B,YAAY;IACZ,WAAW;IACX,iBAAiB;IACjB,yBAAyB;IACzB,eAAe;AACnB;;AAEA;IACI,yBAAyB;AAC7B;;AAEA;IACI,yBAAyB;AAC7B;;AAEA;IACI,SAAS;IACT,mBAAmB;IACnB,cAAc;;AAElB;;AAEA;IACI,yBAAyB;IACzB,mBAAmB;IACnB,kBAAkB;IAClB,YAAY;IACZ,aAAa;AACjB;;AAEA;IACI,gBAAgB;AACpB;;AAEA;IACI,YAAY;AAChB;;AAEA;IACI,eAAe;AACnB;;AAEA;IACI,kBAAkB;IAClB,0BAA0B;IAC1B,yBAAyB;IACzB,oBAAoB;IACpB,eAAe;IACf,cAAc;AAClB;;AAEA;IACI,eAAe;AACnB;;AAEA;IACI,kBAAkB;IAClB,kBAAkB;IAClB,WAAW;IACX,YAAY;AAChB;;AAEA;IACI,aAAa;AACjB;;AAEA;IACI,YAAY;AAChB;;AAEA;IACI,aAAa;IACb,sBAAsB;IACtB,QAAQ;AACZ;;AAEA;IACI,yBAAyB;IACzB,YAAY;AAChB;;AAEA;IACI,yBAAyB;AAC7B;;;AAGA;IACI,kBAAkB;IAClB,aAAa;IACb,sBAAsB;IACtB,aAAa;IACb,YAAY;IACZ,mBAAmB;IACnB,aAAa;IACb,eAAe;IACf,QAAQ;IACR,YAAY;IACZ,yBAAyB;IACzB,kBAAkB;AACtB;;AAEA;IACI,mCAAmC;AACvC;;AAEA;IACI,kBAAkB;IAClB,aAAa;IACb,4BAA4B;IAC5B,yBAAyB;IACzB,eAAe;AACnB;;AAEA;IACI,qBAAqB;IACrB,oBAAoB;AACxB;;AAEA;IACI,kBAAkB;IAClB,aAAa;IACb,sBAAsB;IACtB,0BAA0B;IAC1B,kBAAkB;IAClB,eAAe;AACnB;;AAEA;IACI,aAAa;IACb,mBAAmB;AACvB;;AAEA;IACI,gBAAgB;AACpB;;AAEA;IACI,kBAAkB;IAClB,WAAW;AACf;;AAEA;IACI,aAAa;IACb,QAAQ;IACR,WAAW;AACf;AACA;IACI,eAAe;AACnB;;AAEA;IACI,WAAW;IACX,iBAAiB;AACrB;AACA;IACI,iBAAiB;IACjB,aAAa;IACb,SAAS;AACb;;AAEA;IACI,aAAa;AACjB;;AAEA;IACI,6BAA6B;AACjC;;AAEA;IACI,kBAAkB;IAClB,gBAAgB;IAChB,WAAW;IACX,YAAY;IACZ,mBAAmB;IACnB,mBAAmB;IACnB,eAAe;AACnB;;AAEA;IACI,kBAAkB;IAClB,YAAY;IACZ,UAAU;IACV,WAAW;IACX,QAAQ;AACZ;;AAEA;IACI,aAAa;IACb,mBAAmB;IACnB,QAAQ;AACZ;;AAEA;IACI,kBAAkB;AACtB;;;AAGA;;;GAGG","sourcesContent":["@font-face {\n    font-family: teko;\n    src: url(./Teko/Teko-VariableFont_wght.ttf);\n}\nbody {\n    position: relative;\n    display: grid;\n    grid-template-columns: 325px 1fr; /* make it responsive* - use fractional*/\n    grid-template-rows: 40px 1fr;\n    margin: 0;\n    font-size: 32px;\n    font-family: teko;\n    height: 100vh;\n    width: calc(1440px) /* look at grid-template-column to change */\n}\n\nheader {\n    grid-column: 1 / 3;\n    grid-row: 1 / 2;\n    background-color: #FFD43B;\n    padding-left: 16px;\n}\n\n.side-bar {\n    background-color: #463f3a;\n    grid-column: 1 / 2;\n    grid-row: 2 / 3;\n    display: flex;\n    flex-direction: column;\n    gap: 5px;\n    padding: 10px 5px;\n}\n\n.side-bar button {\n    text-align: start;\n\n}\n\n.create button, .side-bar button, .dialog-add, .dialog-cancel, .project-container button, .task-container button{\n    font-size: 1rem;\n    color: #FFFFFF;\n    border-style: none;\n    background-color: inherit;\n    font-family: inherit;\n    font-size: 22px;\n    border-radius: 5px;\n    cursor: pointer;\n}\n\n.dialog-add, .dialog-cancel {\n    color: black;\n}\n\n.main {\n    position: relative;\n    grid-column: 2 / 3;\n    grid-row: 2 / 3;\n    background-color: #f2e9e4;\n    padding: 15px 0px 15px 25px;\n    display: flex;\n    flex-direction: column;\n    gap: 10px;\n}\n\n.min-tab, .project-list {\n    margin-left: 16px;\n}\n\nimg{\n    height: 17px;\n}\n\n.add-button {\n    background: no-repeat url(./plus-solid.svg);\n    background-size: 35px;\n    position: absolute;\n    bottom: 80px;\n    right: 80px;\n    border-radius: 50%;\n    background-position: center;\n    height: 55px;\n    width: 55px;\n    border-style:none;\n    background-color: #a7998e;\n    cursor: pointer;\n}\n\n.add-button:hover {\n    background-color: #b2a69d;\n}\n\n.side-bar button:hover, .side-bar button:focus {\n    background-color: #86817d;\n}\n\nhr {\n    margin: 0;\n    border-style: solid;\n    color: #a7998e;\n      \n}\n\ndialog {\n    background-color: #FFD43B;\n    border-radius: 10px;\n    border-style: none;\n    width: 400px;\n    padding: 16px;\n}\n\nform p {\n    margin: 0 0 15px;\n}\n\n.project-container p, .task-container p {\n    margin: 10px;\n}\n\n.bottom-div {\n    text-align: end;\n}\n\ninput, select, textarea {\n    border-style: none;\n    border-bottom-style: solid;\n    background-color: #FFD43B;\n    font-family: inherit;\n    font-size: 30px;\n    color: #463f3a;\n}\n\nselect, input[type='date'], textarea {\n    font-size: 20px;\n}\n\n.color-picker {\n    border-style: none;\n    border-radius: 5px;\n    width: 25px;\n    height: 25px;\n}\n\ninput:focus, select:focus, textarea:focus {\n    outline: none;\n}\n\ntextarea {\n    resize: none;\n}\n\nform {\n    display: flex;\n    flex-direction: column;\n    gap: 8px;\n}\n\ndialog::backdrop {\n    background-color: #403d39;\n    opacity: 0.5;\n}\n\ninput[type='date'] {\n    background-color: #FFD43B;\n}\n\n\n.create {\n    position: absolute;\n    display: flex;\n    flex-direction: column;\n    bottom: 115px;\n    right: 115px;\n    border-radius: 10px;\n    padding: 15px;\n    font-size: 2rem;\n    gap: 5px;\n    width: 100px;\n    background-color: #463f3a;\n    visibility: hidden;\n}\n\n.create, .add-button {\n    box-shadow: 0px 5px 8px 3px #8e8279;\n}\n\n.project-container {\n    border-style: none;\n    display: flex;\n    border-radius: 20px 0 0 20px;\n    background-color: #edd787;\n    cursor: pointer;\n}\n\n.project-container:hover{\n    border-color: #463f3a;\n    border-style: double;\n}\n\n.task-container {\n    position: relative;\n    display: flex;\n    flex-direction: column;\n    border-bottom-style: solid;\n    align-items: start;\n    cursor: pointer;\n}\n\n.checkboxNname, .info {\n    display: flex;\n    align-items: center;\n}\n\n.checkboxNname > p {\n    margin: 0px 10px;\n}\n\n.checkboxNname img, .project-icon-task{\n    position: absolute;\n    right: 20px;\n}\n\n.project-icon-task {\n    display: flex;\n    gap: 5px;\n    bottom: 5px;\n}\n.checkboxNname p, .checkboxNname img {\n    font-size: 30px;\n}\n\n.info > p {\n    margin: 0px;\n    font-size: 17.5px;\n}\n.info {\n    margin-left: 30px;\n    display: flex;\n    gap: 20px;\n}\n\n#priority {\n    display: flex;\n}\n\ninput[type='checkbox']:checked + p {\n    text-decoration: line-through;\n}\n\ninput[type='checkbox'] {\n    border-radius: 4px;\n    appearance: none;\n    width: 20px;\n    height: 20px;\n    border-style: solid;\n    border-width: 1.5px;\n    cursor: pointer;\n}\n\ninput[type='checkbox']:checked::after {\n    position: absolute;\n    content: '✓';\n    width: 2px;\n    height: 2px;\n    top: 4px;\n}\n\n.project-list {\n    display: flex;\n    align-items: center;\n    gap: 5px;\n}\n\n.project-icon {\n    margin-bottom: 5px;\n}\n\n\n/*border style\nbody, header, .side-bar, .project-container, .create {\n    border-style: solid;\n} */"],"sourceRoot":""}]);
// Exports
...
function today(tasks){
    ...
    main.innerHTML = '';
    tasks.forEach(task => {
        if ((0,date_fns__WEBPACK_IMPORTED_MODULE_1__.isToday)((0,date_fns__WEBPACK_IMPORTED_MODULE_2__.parseISO)(task.dueDate))) (0,_taskDOM_js__WEBPACK_IMPORTED_MODULE_0__["default"])(task, tasks);
    });
}
...
function week(tasks){
    ...
    main.innerHTML = '';
    tasks.forEach(task => {
        if ((0,date_fns__WEBPACK_IMPORTED_MODULE_3__.isThisWeek)((0,date_fns__WEBPACK_IMPORTED_MODULE_2__.parseISO)(task.dueDate), { weekStartsOn: 1 })) (0,_taskDOM_js__WEBPACK_IMPORTED_MODULE_0__["default"])(task, tasks); // weekStartsOn: 1 means week starts on monday
     });
}
...
/* harmony export */ });
/* harmony import */ var _storageCRUD_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./storageCRUD.js */ "./src/storageCRUD.js");
/* harmony import */ var _taskDOM_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./taskDOM.js */ "./src/taskDOM.js");



function home (allTasks = (0,_storageCRUD_js__WEBPACK_IMPORTED_MODULE_0__.getValueFromStorage)('all-tasks')){
    const main = document.querySelector('.main');
    main.innerHTML = '';
    allTasks.forEach(task => {
        (0,_taskDOM_js__WEBPACK_IMPORTED_MODULE_1__["default"])(task, allTasks);
    })
...
/* harmony export */ });
/* harmony import */ var _taskDOM_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./taskDOM.js */ "./src/taskDOM.js");
/* harmony import */ var _storageCRUD_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./storageCRUD.js */ "./src/storageCRUD.js");
...
function projects(projects){
    ...
    projects.forEach(project => {
        ...
        projectContainer.addEventListener('click', ()=> {
            (0,_storageCRUD_js__WEBPACK_IMPORTED_MODULE_1__.updateStorage)('current-page', project.name)
            main.innerHTML = '';
        ...
        editProject.addEventListener('click', (e)=> {
            e.stopPropagation();
            (0,_todoAndProjectCreatorDialogBox_js__WEBPACK_IMPORTED_MODULE_2__.projectCreator)(project);
        })
        const deleteProjectButton = document.createElement('button');
        deleteProjectButton.textContent = 'Delete';
        deleteProjectButton.addEventListener('click', (e)=> {
            e.stopPropagation();
            (0,_storageCRUD_js__WEBPACK_IMPORTED_MODULE_1__.deleteProject)(project);
        })
...
function projectTasks(project){
    const projectsArray = (0,_storageCRUD_js__WEBPACK_IMPORTED_MODULE_1__.getValueFromStorage)('projects');
...
/* harmony export */   getValueFromStorage: () => (/* binding */ getValueFromStorage),
...
/* harmony export */ });
/* harmony import */ var _todoAndProjectCreatorDialogBox__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./todoAndProjectCreatorDialogBox */ "./src/todoAndProjectCreatorDialogBox.js");
/* harmony import */ var _storageCRUD_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./storageCRUD.js */ "./src/storageCRUD.js");
...
function taskDisplay(task, tasks){
    ...
    const index = tasks.indexOf(task);
        ...
        dueDate.textContent = `⏲ ${(0,date_fns__WEBPACK_IMPORTED_MODULE_2__.format)((0,date_fns__WEBPACK_IMPORTED_MODULE_3__.parseISO)(task.dueDate), "MMMM do" )}`;
        dueDate.style.color = (0,date_fns__WEBPACK_IMPORTED_MODULE_4__.isBefore)(task.dueDate, (0,date_fns__WEBPACK_IMPORTED_MODULE_2__.format)(Date.now(), 'yyyy-MM-dd')) ? 'red' : 'green';
        ...
        taskContainer.addEventListener('click', ()=> {
            (0,_todoAndProjectCreatorDialogBox__WEBPACK_IMPORTED_MODULE_0__.todoCreator)(task);
        })
        const deleteTask = document.createElement('button');
        deleteTask.textContent = 'delete';
        deleteTask.addEventListener('click', (e)=> {
            e.stopPropagation();
           (0,_storageCRUD_js__WEBPACK_IMPORTED_MODULE_1__.deleteTask)(task, tasks);
           console.log('clicked')
        })
...
/* harmony import */ var _updatePageState_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./updatePageState.js */ "./src/updatePageState.js");
/* harmony import */ var _priority_flags_one_svg__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./priority-flags/one.svg */ "./src/priority-flags/one.svg");
/* harmony import */ var _priority_flags_two_svg__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./priority-flags/two.svg */ "./src/priority-flags/two.svg");
/* harmony import */ var _priority_flags_three_svg__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./priority-flags/three.svg */ "./src/priority-flags/three.svg");
/* harmony import */ var _priority_flags_four_svg__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./priority-flags/four.svg */ "./src/priority-flags/four.svg");
//REFACTOR!!!
...
function todoCreator(editTask = {}){
    ...
    date.setAttribute('value', editTask.dueDate? editTask.dueDate : (0,date_fns__WEBPACK_IMPORTED_MODULE_9__.format)(Date.now(), 'yyyy-MM-dd'));
    date.setAttribute('min', (0,date_fns__WEBPACK_IMPORTED_MODULE_9__.format)(Date.now(), 'yyyy-MM-dd'));
    ...
    add.addEventListener('click', (e)=> {
        ...
        (0,_updatePageState_js__WEBPACK_IMPORTED_MODULE_4__["default"])();
...
function createProjectsDropdown(dropdown, edit, prevOption){
    const projects = (0,_storageCRUD_js__WEBPACK_IMPORTED_MODULE_1__.getValueFromStorage)('projects');
    projects.forEach(project => {
...
function createPriorityDropdown(dropdown, edit, prevOption){
    ...
    one.src = _priority_flags_one_svg__WEBPACK_IMPORTED_MODULE_5__;
    const two = document.createElement('img');
    two.src = _priority_flags_two_svg__WEBPACK_IMPORTED_MODULE_6__;
    const three = document.createElement('img');
    three.src = _priority_flags_three_svg__WEBPACK_IMPORTED_MODULE_7__;
    const four = document.createElement('img');
    four.src = _priority_flags_four_svg__WEBPACK_IMPORTED_MODULE_8__;
    let priorityImg = one;
...
function createDataInStorage(type, data, edit, old){
    ...
    if(type === 'project'){
        ...
        projectToTab = new _project_js__WEBPACK_IMPORTED_MODULE_2__["default"](data.name, []);
        projectsArray.push(projectToTab);
        }
        (0,_storageCRUD_js__WEBPACK_IMPORTED_MODULE_1__.updateStorage)('projects', projectsArray);
        (0,_projectsDOM_js__WEBPACK_IMPORTED_MODULE_0__.projectTab)(projectToTab); 
    } else if(type === 'task'){
        const allTasksArray = (0,_storageCRUD_js__WEBPACK_IMPORTED_MODULE_1__.getValueFromStorage)('all-tasks');
        if(edit){
        ...
        const task = new _todo_js__WEBPACK_IMPORTED_MODULE_3__["default"](data.name, data.description, data.dueDate, 
        ...
        (0,_storageCRUD_js__WEBPACK_IMPORTED_MODULE_1__.updateStorage)('all-tasks', allTasksArray);
    }
}
...
/* harmony import */ var _calendarDOM_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./calendarDOM.js */ "./src/calendarDOM.js");
/* harmony import */ var _projectsDOM_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./projectsDOM.js */ "./src/projectsDOM.js");
/* harmony import */ var _storageCRUD_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./storageCRUD.js */ "./src/storageCRUD.js");
...
function updateState(){
    switch ((0,_storageCRUD_js__WEBPACK_IMPORTED_MODULE_3__.getValueFromStorage)('current-page')) {
        case 'home':
            (0,_homeDOM_js__WEBPACK_IMPORTED_MODULE_0__["default"])((0,_storageCRUD_js__WEBPACK_IMPORTED_MODULE_3__.getValueFromStorage)('all-tasks'));
            break;
        case 'today':
            (0,_calendarDOM_js__WEBPACK_IMPORTED_MODULE_1__.today)((0,_storageCRUD_js__WEBPACK_IMPORTED_MODULE_3__.getValueFromStorage)('all-tasks'));
            break;
        case 'week':
            (0,_calendarDOM_js__WEBPACK_IMPORTED_MODULE_1__.week)((0,_storageCRUD_js__WEBPACK_IMPORTED_MODULE_3__.getValueFromStorage)('all-tasks'));
            break;
        case 'projects':
            (0,_projectsDOM_js__WEBPACK_IMPORTED_MODULE_2__.projects)((0,_storageCRUD_js__WEBPACK_IMPORTED_MODULE_3__.getValueFromStorage)('projects'));
            break;
        default:
            (0,_projectsDOM_js__WEBPACK_IMPORTED_MODULE_2__.projectTasks)((0,_storageCRUD_js__WEBPACK_IMPORTED_MODULE_3__.getProjectFromStorage)((0,_storageCRUD_js__WEBPACK_IMPORTED_MODULE_3__.getValueFromStorage)('current-page')));
            break;
    }
}
...
/***/ "./src/Teko/Teko-VariableFont_wght.ttf":
/*!*********************************************!*\
  !*** ./src/Teko/Teko-VariableFont_wght.ttf ***!
  \*********************************************/
/***/ ((module, __unused_webpack_exports, __webpack_require__) => {

module.exports = __webpack_require__.p + "2c304a82d8b73b2829fa.ttf";
...
module.exports = __webpack_require__.p + "e853ab63b34652d05f8b.svg";

/***/ }),

/***/ "./src/priority-flags/four.svg":
/*!*************************************!*\
  !*** ./src/priority-flags/four.svg ***!
  \*************************************/
/***/ ((module, __unused_webpack_exports, __webpack_require__) => {

module.exports = __webpack_require__.p + "a23607c440667ed21db7.svg";

/***/ }),

/***/ "./src/priority-flags/one.svg":
/*!************************************!*\
  !*** ./src/priority-flags/one.svg ***!
  \************************************/
/***/ ((module, __unused_webpack_exports, __webpack_require__) => {

module.exports = __webpack_require__.p + "6894cbb9478662134388.svg";

/***/ }),

/***/ "./src/priority-flags/three.svg":
/*!**************************************!*\
  !*** ./src/priority-flags/three.svg ***!
  \**************************************/
/***/ ((module, __unused_webpack_exports, __webpack_require__) => {

module.exports = __webpack_require__.p + "8c689b43d77b387b6816.svg";

/***/ }),

/***/ "./src/priority-flags/two.svg":
/*!************************************!*\
  !*** ./src/priority-flags/two.svg ***!
  \************************************/
/***/ ((module, __unused_webpack_exports, __webpack_require__) => {

module.exports = __webpack_require__.p + "aaf86d83da078c8daf50.svg";
...
/* harmony import */ var _todoAndProjectCreatorDialogBox_js__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./todoAndProjectCreatorDialogBox.js */ "./src/todoAndProjectCreatorDialogBox.js");
/* harmony import */ var _storageCRUD_js__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./storageCRUD.js */ "./src/storageCRUD.js");
...
class App {
    ...
    constructor(){
        ...
        (0,_storageCRUD_js__WEBPACK_IMPORTED_MODULE_6__.updateStorage)('projects', this.allProjects);
        (0,_storageCRUD_js__WEBPACK_IMPORTED_MODULE_6__.updateStorage)('all-tasks', this.allTasks);
        (0,_storageCRUD_js__WEBPACK_IMPORTED_MODULE_6__.updateStorage)('current-page', 'home');
    }
    ...
    start(){
        ...
        (0,_homeDOM_js__WEBPACK_IMPORTED_MODULE_1__["default"])(this.allTasks); //landing page loaded with the test tasks

        this.homeButton.addEventListener('click', ()=> {
            (0,_homeDOM_js__WEBPACK_IMPORTED_MODULE_1__["default"])((0,_storageCRUD_js__WEBPACK_IMPORTED_MODULE_6__.getValueFromStorage)('all-tasks'));
            (0,_storageCRUD_js__WEBPACK_IMPORTED_MODULE_6__.updateStorage)('current-page', 'home');
        })
        this.todayButton.addEventListener('click', ()=> {
            ;(0,_calendarDOM_js__WEBPACK_IMPORTED_MODULE_3__.today)((0,_storageCRUD_js__WEBPACK_IMPORTED_MODULE_6__.getValueFromStorage)('all-tasks'));
            (0,_storageCRUD_js__WEBPACK_IMPORTED_MODULE_6__.updateStorage)('current-page', 'today');
        })
        this.weekButton.addEventListener('click', ()=> {
            ;(0,_calendarDOM_js__WEBPACK_IMPORTED_MODULE_3__.week)((0,_storageCRUD_js__WEBPACK_IMPORTED_MODULE_6__.getValueFromStorage)('all-tasks'));
            (0,_storageCRUD_js__WEBPACK_IMPORTED_MODULE_6__.updateStorage)('current-page', 'week');
        })
        this.projectsButton.addEventListener('click', ()=> {
            ;(0,_projectsDOM_js__WEBPACK_IMPORTED_MODULE_4__.projects)((0,_storageCRUD_js__WEBPACK_IMPORTED_MODULE_6__.getValueFromStorage)('projects')); //projectsDOM([testProject, testProject2, testProject3]);
            (0,_storageCRUD_js__WEBPACK_IMPORTED_MODULE_6__.updateStorage)('current-page', 'projects');
        })
        ...
        this.addTask.addEventListener('click', ()=> {
            ;(0,_todoAndProjectCreatorDialogBox_js__WEBPACK_IMPORTED_MODULE_5__.todoCreator)();
        })

        this.addProject.addEventListener('click', ()=>{
            ;(0,_todoAndProjectCreatorDialogBox_js__WEBPACK_IMPORTED_MODULE_5__.projectCreator)();
        })
    }
