...
body, header, .side-bar, .project-container, .create {
    border-style: solid;
}`, "",{"version":3,"sources":["webpack://./src/style.css"],"names":[],"mappings":"AAAA;IACI,kBAAkB;IAClB,aAAa;IACb,gCAAgC,EAAE,wCAAwC;IAC1E,4BAA4B;IAC5B,SAAS;IACT,aAAa;IACb,kBAAkB,EAAE,2CAA2C;AACnE;;AAEA;IACI,kBAAkB;IAClB,eAAe;AACnB;;AAEA;IACI,kBAAkB;IAClB,eAAe;IACf,aAAa;IACb,sBAAsB;AAC1B;;AAEA;IACI,kBAAkB;IAClB,kBAAkB;IAClB,eAAe;AACnB;;AAEA;IACI,kBAAkB;IAClB,YAAY;IACZ,WAAW;IACX,kBAAkB;IAClB,aAAa;AACjB;;AAEA;IACI,kBAAkB;IAClB,aAAa;IACb,sBAAsB;IACtB,aAAa;IACb,YAAY;IACZ,mBAAmB;IACnB,aAAa;IACb,kBAAkB;AACtB;;AAEA,eAAe;AACf;IACI,mBAAmB;AACvB","sourcesContent":["body {\n    position: relative;\n    display: grid;\n    grid-template-columns: 325px 1fr; /* make it responsive* - use fractional*/\n    grid-template-rows: 60px 1fr;\n    margin: 0;\n    height: 100vh;\n    width: calc(1440px) /* look at grid-template-column to change */\n}\n\nheader {\n    grid-column: 1 / 3;\n    grid-row: 1 / 2;\n}\n\n.side-bar {\n    grid-column: 1 / 2;\n    grid-row: 2 / 3;\n    display: flex;\n    flex-direction: column;\n}\n\n.main {\n    position: relative;\n    grid-column: 2 / 3;\n    grid-row: 2 / 3;\n}\n\n.add-button {\n    position: absolute;\n    bottom: 80px;\n    right: 80px;\n    border-radius: 50%;\n    padding: 15px;\n}\n\n.create {\n    position: absolute;\n    display: flex;\n    flex-direction: column;\n    bottom: 110px;\n    right: 110px;\n    border-radius: 10px;\n    padding: 15px;\n    visibility: hidden;\n}\n\n/*border style*/\nbody, header, .side-bar, .project-container, .create {\n    border-style: solid;\n}"],"sourceRoot":""}]);
// Exports
...
function todoCreator(editTask = {}){
    ...
    date.setAttribute('min', editTask.dueDate? (0,date_fns__WEBPACK_IMPORTED_MODULE_5__.format)(new Date(editTask.dueDate), 'yyyy-MM-dd'): (0,date_fns__WEBPACK_IMPORTED_MODULE_5__.format)(Date.now(), 'yyyy-MM-dd'));
...
function updateState(){
    switch ((0,_storageCRUD_js__WEBPACK_IMPORTED_MODULE_3__.getValueFromStorage)('current-page')) {
        ...
        case 'projects':
            ...
            break;
        default:
            (0,_projectsDOM_js__WEBPACK_IMPORTED_MODULE_2__.projectTasks)((0,_storageCRUD_js__WEBPACK_IMPORTED_MODULE_3__.getValueFromStorage)('current-page'));
            break;
    }
}
