...
/*border style*/
body, header, .side-bar, .project-container {
    border-style: solid;
}`, "",{"version":3,"sources":["webpack://./src/style.css"],"names":[],"mappings":"AAAA;IACI,aAAa;IACb,gCAAgC,EAAE,wCAAwC;IAC1E,4BAA4B;IAC5B,SAAS;IACT,aAAa;IACb,kBAAkB,EAAE,2CAA2C;AACnE;;AAEA;IACI,kBAAkB;IAClB,eAAe;AACnB;;AAEA;IACI,kBAAkB;IAClB,eAAe;IACf,aAAa;IACb,sBAAsB;AAC1B;;AAEA;IACI,kBAAkB;IAClB,eAAe;AACnB;;AAEA,eAAe;AACf;IACI,mBAAmB;AACvB","sourcesContent":["body {\n    display: grid;\n    grid-template-columns: 325px 1fr; /* make it responsive* - use fractional*/\n    grid-template-rows: 60px 1fr;\n    margin: 0;\n    height: 100vh;\n    width: calc(1440px) /* look at grid-template-column to change */\n}\n\nheader {\n    grid-column: 1 / 3;\n    grid-row: 1 / 2;\n}\n\n.side-bar {\n    grid-column: 1 / 2;\n    grid-row: 2 / 3;\n    display: flex;\n    flex-direction: column;\n}\n\n.main {\n    grid-column: 2 / 3;\n    grid-row: 2 / 3;\n}\n\n/*border style*/\nbody, header, .side-bar, .project-container {\n    border-style: solid;\n}"],"sourceRoot":""}]);
// Exports
...
function today(tasks){
    tasks.forEach(task => {
        if ((0,date_fns__WEBPACK_IMPORTED_MODULE_1__.isToday)(task.dueDate)) (0,_taskDOM_js__WEBPACK_IMPORTED_MODULE_0__["default"])(task);
    });
}

function week(tasks){
    tasks.forEach(task => {
        if ((0,date_fns__WEBPACK_IMPORTED_MODULE_2__.isThisWeek)(task.dueDate, { weekStartsOn: 1 })) (0,_taskDOM_js__WEBPACK_IMPORTED_MODULE_0__["default"])(task); // weekStartsOn: 1 means week starts on monday
     });
}
...
function projectTasks(project){
    ...
    tasks.forEach(task => {
        (0,_taskDOM_js__WEBPACK_IMPORTED_MODULE_0__["default"])(task);
    });
}
