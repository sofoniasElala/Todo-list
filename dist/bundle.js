...
function todoCreator(){
    ...
    date.setAttribute('value', (0,date_fns__WEBPACK_IMPORTED_MODULE_1__.format)(Date.now(), 'yyyy-MM-dd'));
    date.setAttribute('min', (0,date_fns__WEBPACK_IMPORTED_MODULE_1__.format)(Date.now(), 'yyyy-MM-dd'));
