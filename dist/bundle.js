...
function todoCreator(){
    ...
    date.setAttribute('value', (0,date_fns__WEBPACK_IMPORTED_MODULE_4__.format)(Date.now(), 'yyyy-MM-dd'));
    date.setAttribute('min', (0,date_fns__WEBPACK_IMPORTED_MODULE_4__.format)(Date.now(), 'yyyy-MM-dd'));
...
function createDataInStorage(type, data){
    const projectsArray = (0,_storageCRUD_js__WEBPACK_IMPORTED_MODULE_1__.getValueFromStorage)('projects');
    if(type === 'project'){
        const project = new _project_js__WEBPACK_IMPORTED_MODULE_2__["default"](data.name, []);
        projectsArray.push(project);
        (0,_storageCRUD_js__WEBPACK_IMPORTED_MODULE_1__.updateStorage)('projects', projectsArray);
        (0,_projectsDOM_js__WEBPACK_IMPORTED_MODULE_0__.projectTab)(project);
    } else if(type === 'task'){
...
class App {
    ...
    start(){
        ...
        const testProjectTask = new _todo_js__WEBPACK_IMPORTED_MODULE_0__["default"]('jump rope', '20 x 4', '',(0,date_fns__WEBPACK_IMPORTED_MODULE_8__.format)(Date.now(), "MM/dd/yyyy"),'', testProject.name, false);
        testProject.addTask(testProjectTask);
        this.allProjects.push(testProject);
        this.allTasks.push(testProjectTask);

        const testProjectTask1 = new _todo_js__WEBPACK_IMPORTED_MODULE_0__["default"]('squat', '300 x 4', '', (0,date_fns__WEBPACK_IMPORTED_MODULE_8__.format)(new Date(2024, 2, 10), "MM/dd/yyyy"),'', testProject.name, false);
        testProject.addTask(testProjectTask1);
        this.allProjects.push(testProject2);
        this.allTasks.push(testProjectTask1);

        const testProjectTask2 = new _todo_js__WEBPACK_IMPORTED_MODULE_0__["default"]('bench press', '150 x 4', '', (0,date_fns__WEBPACK_IMPORTED_MODULE_8__.format)(Date.now(), "MM/dd/yyyy"),'', testProject.name, false);
